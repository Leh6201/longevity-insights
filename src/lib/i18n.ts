...
const resources = {
  pt: {
    translation: {
      ...
      smartSummaryNoDataTitle: "Vamos conhecer você melhor",
      smartSummaryNoDataDescription: "Complete seu perfil ou envie um exame para receber um resumo personalizado da sua saúde.",
      completeProfile: "Completar Perfil",
      smartSummaryHeadlinePositive: "Você está cuidando bem do seu corpo!",
      smartSummaryHeadlineBalanced: "Você tem bons hábitos que estão refletindo nos seus resultados.",
      smartSummaryHeadlineAttention: "Seus exames trazem informações importantes. Vamos entender juntos?",
      smartSummaryAgeYounger: "Sua idade biológica está {{years}} anos mais jovem que sua idade real, um sinal de que seus hábitos estão funcionando.",
      smartSummaryAgeOlder: "Sua idade biológica está {{years}} anos acima da sua idade real. Com alguns ajustes, podemos melhorar isso.",
      smartSummaryAgeEqual: "Sua idade biológica está alinhada com sua idade real.",
      smartSummaryAllNormal: "Todos os seus biomarcadores estão dentro da faixa saudável.",
      smartSummaryMostNormal: "{{normal}} de {{total}} biomarcadores estão saudáveis.",
      smartSummarySomeAttention: "{{attention}} de {{total}} biomarcadores merecem um olhar mais atento.",
      smartSummaryNormal: "Normais",
      smartSummaryAttention: "Atenção",
      smartSummaryGoodSleep: "Sua qualidade de sono está contribuindo para sua saúde",
      smartSummaryPoorSleep: "Melhorar o sono pode trazer benefícios significativos",
      smartSummaryGoodActivity: "Sua rotina de exercícios está fortalecendo seu corpo",
      smartSummaryNoActivity: "Adicionar atividade física pode melhorar sua energia",
      smartSummaryGoodHydration: "Sua hidratação está adequada",
      smartSummaryLowHydration: "Aumentar a ingestão de água pode melhorar seu bem-estar",
      smartSummaryGoodMentalHealth: "Você está cuidando bem da sua saúde mental",
      smartSummaryLowMentalHealth: "Sua saúde mental merece atenção especial",
      smartSummaryNoAlcohol: "Evitar álcool contribui para sua longevidade",
      smartSummaryHighAlcohol: "Reduzir o consumo de álcool pode beneficiar sua saúde",
      smartSummaryGoalConnection: "Com base no seu objetivo de {{goal}}, seus hábitos atuais estão no caminho certo.",
      smartSummaryViewMore: "Ver mais detalhes",
      smartSummaryViewLess: "Ver menos",
      smartSummaryPositivePointsTitle: "Pontos Positivos",
      smartSummaryAttentionPointsTitle: "Áreas de Atenção",
      smartSummaryNextStepTitle: "Próximo Passo",
      smartSummaryNextStepAttention: "Revise os insights detalhados abaixo para entender melhor cada ponto de atenção.",
      smartSummaryNextStepUpload: "Envie seus exames para descobrir sua idade biológica e receber insights mais precisos.",
      smartSummaryNextStepMaintain: "Continue mantendo seus bons hábitos para preservar sua saúde.",
