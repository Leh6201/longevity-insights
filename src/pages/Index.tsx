  ...
  return <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerChildren} className="text-center space-y-10">
            ...
            <motion.p variants={fadeInUp} className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-light px-4">
            ...
            {/* Stats bar */}
            <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-16 pt-12 sm:pt-16 px-4">
              {[{
              value: "13",
              label: "Biomarcadores"
            }, {
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            ease: [0.22, 1, 0.36, 1]
              ...
              <div className="flex flex-col gap-4 pt-4">
                {[{
                icon: Clock,
                text: "Upload rápido e processamento automático"
              }, {
                icon: Brain,
                text: "Inteligência artificial de última geração"
              }, {
                icon: Shield,
              ...
              <div className="relative">
                ...
                <div className="relative bg-card rounded-2xl sm:rounded-3xl shadow-2xl border border-border/50 p-4 sm:p-8 backdrop-blur-sm overflow-hidden">
                  ...
                  <div className="space-y-3">
                    ...
                    status: 'success',
                    max: 100
                  }].map((item, i) => <motion.div key={item.name} initial={{
                    opacity: 0,
                    x: 20
                  }} whileInView={{
                    opacity: 1,
            ...
            ease: [0.22, 1, 0.36, 1]
              ...
              duration: 0.3
                ...
                <div className="h-24 sm:h-32 flex items-end gap-1 sm:gap-2 pt-4">
                  {[45, 60, 75, 70, 55, 50, 40, 35, 30].map((h, i) => <motion.div key={i} initial={{
                  height: 0
                }} whileInView={{
                  height: `${h}%`
                }} viewport={{
              ...
              scale: 1.01
                  ...
                  <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center relative overflow-hidden flex-shrink-0`}>
                    ...
                    <svg className="absolute inset-0 w-full h-full" viewBox="0 0 56 56">
                      ...
                      <motion.circle cx="28" cy="28" r="24" fill="none" stroke={`hsl(var(--${item.color}))`} strokeWidth="4" strokeLinecap="round" strokeDasharray="150.8" initial={{
                    strokeDashoffset: 150.8
                  }} whileInView={{
                    strokeDashoffset: 150.8 - 150.8 * Math.abs(item.percent) / 100
                  }} viewport={{
                    once: true
                  }} transition={{
                    delay: 0.5 + i * 0.1,
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            ease: [0.22, 1, 0.36, 1]
              ...
              <div className="flex flex-col gap-4 pt-4">
                {[{
                icon: FileText,
                text: "Relatórios PDF completos e profissionais"
              }, {
                icon: LineChart,
                text: "Histórico de biomarcadores incluído"
              }, {
                icon: Sparkles,
                text: "Recomendações personalizadas anexadas"
              }].map((item, i) => <motion.div key={i} initial={{
                opacity: 0,
                x: -20
              }} whileInView={{
                  ...
                  <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-border/50 flex items-center justify-between gap-2">
                    ...
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-secondary rounded-lg flex items-center justify-center flex-shrink-0">
                      <div className="w-9 h-9 sm:w-12 sm:h-12 grid grid-cols-4 gap-0.5">
                        {Array(16).fill(0).map((_, i) => <div key={i} className={`${Math.random() > 0.4 ? 'bg-foreground' : 'bg-transparent'}`} />)}
                      </div>
                    </div>
                  </div>
                </div>
