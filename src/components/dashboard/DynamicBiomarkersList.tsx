          ...
          <CardHeader className="pb-2">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              <span className="text-sm font-normal text-muted-foreground">
                ({groupedBiomarkers[category].length})
              </span>
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {groupedBiomarkers[category].map((biomarker, index) => (
              <BiomarkerProgressCard
                ...
                infoText={formatBiomarkerInfo(biomarker)}
              />
            ))}
          </CardContent>
        </Card>
...
// Helper function to format biomarker info for tooltip
const formatBiomarkerInfo = (biomarker: DetectedBiomarker): string => {
  const parts: string[] = [];
