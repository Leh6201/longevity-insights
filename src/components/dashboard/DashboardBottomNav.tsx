  ...
  return <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-t border-border">
      <div className="w-full h-16 px-safe">
        <div className="flex items-center h-full max-w-sm mx-auto">
          ...
          const Icon = tab.icon;
          return <button key={tab.id} onClick={() => onTabChange(tab.id)} className="relative flex flex-col items-center justify-center flex-1 h-full min-w-0 transition-colors">
