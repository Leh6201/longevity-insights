...
const resources = {
  pt: {
    translation: {
      ...
      biomarkersInfoTitle: "O que são Biomarcadores?",
      biomarkersInfoDescription: "Biomarcadores são indicadores biológicos medidos em exames de sangue que mostram como seu corpo está funcionando. Eles ajudam a identificar riscos de saúde antes de se tornarem problemas.",
      biomarkersGlucoseInfo: "Glicose: Mede o nível de açúcar no sangue. Importante para detectar diabetes.",
      biomarkersCholesterolInfo: "Colesterol Total: Gordura essencial no sangue, mas em excesso pode entupir artérias.",
      biomarkersHDLInfo: "HDL (Colesterol Bom): Remove o colesterol ruim das artérias, protegendo o coração.",
      biomarkersLDLInfo: "LDL (Colesterol Ruim): Em excesso, pode se depositar nas artérias causando problemas cardíacos.",
      biomarkersImportance: "Acompanhar esses valores ajuda você a prevenir doenças e viver mais e melhor!",
      normal: "Normal",
      actions: "Ações",
